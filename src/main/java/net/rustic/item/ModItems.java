...
import net.rustic.item.custom.food.ChiliPepperFoodItem;
import net.rustic.item.custom.food.TomatoProjectile;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> CHILI_PEPPER = ITEMS.register("chili_pepper", () -> new ChiliPepperFoodItem(new Item.Properties().food(ModFoods.CHILI_PEPPER)));
