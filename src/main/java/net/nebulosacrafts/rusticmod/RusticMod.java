package net.nebulosacrafts.rusticmod;
...
import net.nebulosacrafts.rusticmod.item.RusticModCreativeModeTabs;
import net.nebulosacrafts.rusticmod.item.ModItems;
import org.slf4j.Logger;

// The value here should match an entry in the META-INF/mods.toml file
@Mod(RusticMod.MOD_ID)
public class RusticMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "rusticport";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public RusticMod(FMLJavaModLoadingContext context)
    {
